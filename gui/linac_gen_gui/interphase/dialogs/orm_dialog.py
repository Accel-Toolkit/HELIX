...
from linac_gen_gui.interphase.dialogs._fingerprint import (  # noqa: E402  (shared with the Reliability Study dialog)
    optics_fingerprint as _optics_fingerprint, scalars as _scalars)
